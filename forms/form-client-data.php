...
function form_client_data()
{
	...
	<div class="go-surf-container step-final gs-row-float">
		<form id="form-client-data" method="post" action="?step=final">
			<div class="column1 gs-set-wrap-flex">
				<div class="bookrow gs-row-float gs-items gs-flex-2-col">
					...
					<div class="rightcol gs-set-flex">
						...
						<div class="linecol">
							<input name="fullname" type="text" class="gs-require tooltipstered" value="">
						</div>
					</div>
				</div>
				<div class="bookrow gs-row-float gs-items gs-flex-2-col">
					...
					<div class="rightcol">
						<div class="linecol">
							<input name="email" type="text"
							       class="emailrequired gs-require fulllength tooltipstered"
							       value="">
						</div>
					</div>
				</div>
